...
const Top10Refrigrators = () => {
        ...
        <div className="owner">
          ...
          <div className="name">
            <h2 className="top10title">
              Best Refrigerators In India 2019 – Review’s & Buyer’s Guide <br />
            </h2>
          </div>
        </div>
        <Row>
          <Col className="ml-auto mr-auto text-center" md="16">
            <h5 className="top10title" style={{ marginLeft: '3%', marginRight: '3%' }}>
              Want to buy a new fridge but wondering what to buy. Here we give you the in depth
              review and help you out to buy the best suitable refrigerators available in India.
              With the detailed review mentioned you can conveniently make selection. Amazon alone
              has about 2000 refrigerators of various size, capacity and brands listed.
              <br />
              <br />
              Refrigerators are a must-have nowadays in every modern kitchen. It is an expensive purchase.
  ...
  const items = [
    {
      src: require("assets/img/products/fridge-wall-3.jpg"),
      // altText: "Whirlpool",
      // caption: "Whirlpool"
    },
    {
      src: require("assets/img/products/fridge-wall-2.jpg"),
      // altText: "Samsung",
      // caption: "Samsung"
    },
    {
      src: require("assets/img/products/fridge-wall-1.jpg"),
      // altText: "Godrej",
      // caption: "Godrej"
    }
  ];
...
export default Top10Refrigrators;
